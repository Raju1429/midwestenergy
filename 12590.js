...
! function(e, t) {
    ...
    function u(e, t, r, n, s, i) {
        return D(Math.pow((q(r) - q(e)) * s, 2) + Math.pow((q(n) - q(
            t)) * i, 2))
    }
    ...
    function z(e) {
        ...
        var g = r || {
            ...
            x = g.width,
            m = g.height;
        if (r && (x || m) || !M[h] || (x = s(e, M[h][0]), m = s(e, M[h][1]),
    ...
    function A(e, t) {
        ...
        var r = f.getComputedStyle(e),
            ...
            i = n.indexOf(",");
        return i < 0 && (i = n.indexOf(" ")), t < (n = i < 0 ? t : q(n.substr(0,
            i))) && (n = t), [-s || 0, n - s || 0]
    }

    function B() {
        l() && (f = window, d = t = m(), k = t.utils.toArray, c = t.core.getStyleSaver,
        ...
        n = {
            ...
            init: function init(e, t, n) {
                ...
                return this.styles = c && c(e,
                    ...
                    .indexOf(" ") && (t = "0 " + t) : t = "0 0", i = function _parse(e, t, n) {
                        var s, i,
                            o = e.indexOf(" ");
                        return i = o < 0 ? (s = void 0 !== n ? n + "" : e, e) : (s = e
                            .substr(0, o), e.substr(o + 1)), s = r(s, t), (i = r(i, t)) < s ? [i, s] : [s,
                            i
                        ]
                    }(t, a, (s = A(e, a))[0]), this._length = p(a), this._dash = p(s[1] - s[0]),
                    ...
                    .strokeLinejoin && (i = q(o.strokeMiterlimit), this.add(e.style, "strokeMiterlimit",
                        ...
                        "").indexOf("nowrap"), this._props.push("drawSVG"), 1
            },
            render: function render(e,
                ...
                if (t.tween._time || !g()) {
                    var r, n, s, i, o = t._pt,
                        a = t._style;
                    if (o) {
                        for (t._live && (r = z(t._target)) !== t._length && (n = r /
