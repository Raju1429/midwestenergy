...
t = this, e = function() {
    ...
    class Animate {
        advance(t) {
            ...
            let e = !1;
            if (this.lerp) this.value = (i = this.value, s = this.to, o = 60 * this.lerp, n = t, function(t, e, i) {
                return (1 - i) * t + i * e
            }(i, s, 1 - Math.exp(-o * n))), Math.round(this.value) === this.to && (this.value = this.to, e = !0);
            else {
                this.currentTime += t;
    ...
    return i = new WeakMap, s = new WeakMap, o = new WeakMap, n = new WeakMap, class Lenis {
        constructor({
            wrapper: t = window,
            ...
            i.set(this, !1), s.set(this, !1), o.set(this, !1), n.set(this, !1), this.onVirtualScroll = ({
                deltaX: t,
                deltaY: e,
                event: i
            }) => {
                ...
                if (l = l.slice(0, l.indexOf(this.rootElement)), l.find((t => {
                        var e, i, n, r;
                        return (null === (e = t.hasAttribute) || void 0 === e ? void 0 : e.call(t, "data-lenis-prevent")) || s && (null === (i = t.hasAttribute) || void 0 === i ? void 0 : i.call(t, "data-lenis-prevent-touch")) || o && (null === (n = t.hasAttribute) || void 0 === n ? void 0 : n.call(t, "data-lenis-prevent-wheel")) || (null === (r = t.classList) || void 0 === r ? void 0 : r.contains("lenis"))
                    }))) return;
            ...
            }, window.lenisVersion = "1.0.36", t !== document.documentElement && t !== document.body || (t = window), this.options = {
                wrapper: t,
                content: e,
                wheelEventsTarget: r,
                eventsTarget: l,
                ...
                content: e,
                autoResize: T
            }), this.toggleClass("lenis", !0), this.velocity = 0, this.isLocked = !1, this.isStopped = !1, this.isSmooth = a || h, this.isScrolling = !1, this.targetScroll = this.animatedScroll = this.actualScroll, this.options.wrapper.addEventListener("scroll", this.onNativeScroll, {
                passive: !1
        ...
        set isSmooth(s) {
            t(this, i, "f") !== s && (e(this, i, s, "f"), this.toggleClass("lenis-smooth", s))
        }
        get isScrolling() {
            return t(this, s, "f")
        }
        set isScrolling(i) {
            t(this, s, "f") !== i && (e(this, s, i, "f"), this.toggleClass("lenis-scrolling", i))
        }
        get isStopped() {
            return t(this, o, "f")
        }
        set isStopped(i) {
            t(this, o, "f") !== i && (e(this, o, i, "f"), this.toggleClass("lenis-stopped", i))
        }
        get isLocked() {
            return t(this, n, "f")
        }
        set isLocked(i) {
            t(this, n, "f") !== i && (e(this, n, i, "f"), this.toggleClass("lenis-locked", i))
        }
        get className() {
            let t = "lenis";
