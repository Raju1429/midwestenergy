        ...
        window.tram = function(e) {
                    ...
                    function p(x, K) {
                        ...
                        return ft.constructor = c, c.mixin = function(j) {
                            ...
                            if (z = {}, s(j) ? z = j.call(c, ft, Z, c, x) : r(j) && (z = j), r(z))
                                for (var At in z) n.call(z, At) && (ft[At] = z[At]);
            ...
            var V = y.frame = function() {
                ...
                pt = P(function(t) {
                    ...
                    function r(w) {
                        w = I(w, 0), this.active ? this.queue.push({
                            options: w
                        }) : (this.timer = new qt({
                            duration: w,
                            context: this,
                    ...
                    function x(w) {
                        p.call(this, w), ft.call(this, w, At, ge)
                    }
                    ...
                    function z() {
                        p.call(this), e.removeData(this.el, $), this.$el = this.el = null
                    }
                    ...
                    }, ot("add", n), ot("start", i), ot("wait", r), ot("then", s), ot("next", o), ot("stop", p), ot("set", x), ot("show", K), ot("hide", c), ot("redraw", A), ot("destroy", z)
                }),
                J = P(pt, function(t) {
                    function n(i, r) {
                ...
                S = P(function(t) {
                    ...
                    t.init = function(o, p, x, K) {
                        ...
                        var c = p[0];
                        x[2] && (c = x[2]), Ht[c] && (c = Ht[c]), this.name = c, this.type = x[1], this.duration = I(p[1], this.duration, s.duration), this.ease = i(p[2], this.ease, s.ease), this.delay = I(p[3], this.delay, s.delay), this.span = this.duration + this.delay, this.active = !1, this.nextStyle = null, this.auto = kt.test(this.name), this.unit = K.unit || this.unit || et.defaultUnit, this.angle = K.angle || this.angle || et.defaultAngle, et.fallback || K.fallback ? this.animate = this.fallback : (this.animate = this.transition, this.string = this.name + vt + this.duration + "ms" + (this.ease != "ease" ? vt + R[this.ease][0] : "") + (this.delay ? vt + this.delay + "ms" : ""))
                    }, t.set = function(o) {
                        ...
                        o = this.convert(o, this.type), this.auto && (p == "auto" && (p = this.convert(this.get(), this.type)), o == "auto" && (o = n.call(this))), this.tween = new St({
                            from: p,
                            to: o,
                        ...
                        switch (p) {
                            case f:
                                if (K) return o;
                                if (c && o.replace(q, "") === "") return +o;
                                x = "number(unitless)";
                                break;
                            case E:
                                if (c) {
                                    if (o === "" && this.original) return this.original;
                                    if (p.test(o)) return o.charAt(0) == "#" && o.length == 7 ? o : r(o)
                                }
                                x = "hex or rgb string";
                                break;
                            case m:
                                if (K) return o + this.unit;
                                if (c && p.test(o)) return o;
                ...
                Tt = P(S, function(t, n) {
                    function i(r, s) {
                        var o, p, x, K, c;
                        for (o in r) K = mt[o], x = K[0], p = K[1] || o, c = this.convert(r[o], x), s.call(this, p, c, x)
                    }
                    t.init = function() {
                        ...
                        var o, p = {};
                        for (o in this.current) p[o] = o in s ? s[o] : this.current[o];
                        ...
                        return i.call(this, r, function(p, x, K) {
                            o[p] = x, this.current[p] === void 0 && (s = 0, ~p.indexOf("scale") && (s = 1), this.current[p] = this.convert(s, K))
                        }), o
                    }
                }),
                St = P(function(t) {
                    ...
                    function i() {
                        var c, A, z, Z = x.length;
                        if (Z)
                            for (V(i), A = ct(), c = Z; c--;) z = x[c], z && z.render(A)
                    }

                    function r(c) {
                        var A, z = e.inArray(c, x);
                    ...
                    t.init = function(c) {
                        ...
                        var A = c.ease || p.ease;
                        R[A] && (A = R[A][1]), typeof A != "function" && (A = p.ease), this.ease = A, this.update = c.update || g, this.complete = c.complete || g, this.context = c.context || this, this.name = c.name;
                        var z = c.from,
                            Z = c.to;
                        z === void 0 && (z = p.from), Z === void 0 && (Z = p.to), this.unit = c.unit || "", typeof z == "number" && typeof Z == "number" ? (this.begin = z, this.change = Z - z) : this.format(Z, z), this.value = this.begin + this.unit, this.start = ct(), c.autoplay !== !1 && this.play()
                    }, t.play = function() {
                        this.active || (this.start || (this.start = ct()), this.active = !0, n(this))
                    }, t.stop = function() {
                        this.active && (this.active = !1, r(this))
                    }, t.render = function(c) {
                        var A, z = c - this.start;
                        if (this.delay) {
                        ...
                        A = this.endHex || this.begin + this.change, this.value = A + this.unit, this.update.call(this.context, this.value), this.complete.call(this.context), this.destroy()
                    }, t.format = function(c, A) {
                        if (A += "", c += "", c.charAt(0) == "#") return this.startRGB = T(A), this.endRGB = T(c), this.endHex = c, this.begin = 0, void(this.change = 1);
                        if (!this.unit) {
                            var z = A.replace(q, ""),
                                Z = c.replace(q, "");
                            z !== Z && _("tween", A, c), this.unit = z
                        }
                        A = parseFloat(A), c = parseFloat(c), this.begin = this.value = A, this.change = c - A
                    }, t.destroy = function() {
                ...
                Nt = P(St, function(t, n) {
                    t.init = function(i) {
                        ...
                        var r, s, o = this.tweens.length,
                            p = !1;
                        for (r = o; r--;) s = this.tweens[r], s.context && (s.render(i), this.current[s.name] = s.value, p = !0);
        ...
        Kt.exports = function() {
            ...
            e.map = e.collect = function(a, u, v) {
                ...
                return G(a, function(F, k, V) {
                    if (u.call(v, F, k, V)) return h = F, !0
                }), h
            ...
            var G = e.some = e.any = function(a, u, v) {
                ...
                return a == null ? h : $ && a.some === $ ? a.some(u, v) : (M(a, function(F, k, V) {
                    if (h || (h = u.call(v, F, k, V))) return y
                }), !!h)
            };
            e.contains = e.include = function(a, u) {
                ...
                for (var u = 1, v = arguments.length; u < v; u++) {
                    var h = arguments[u];
                    for (var F in h) a[F] === void 0 && (a[F] = h[F])
                }
                return a
            }, e.keys = function(a) {
...
` + k + "}", pt
    ...
    var gt = lt((Ie, te) => {
        ...
        D.ready = function() {
            Mt = !0, $t ? qe() : at.each(xt, Ut), at.each(It, Ut), D.resize.up()
        };
        ...
        D.destroy = function(e) {
            e = e || {}, $t = !0, ut.triggerHandler("__wf_destroy"), e.domready != null && (Mt = e.domready), at.each(Et, Zt), D.resize.off(), D.scroll.off(), D.redraw.off(), xt = [], It = [], yt.state() === "pending" && jt()
        };
        wt(D.ready);
        jt();
    ...
    var ie = lt(($e, ne) => {
        ...
        ee.define("brand", ne.exports = function(e) {
            ...
            y.ready = function() {
                ...
                /\.webflow\.io$/i.test(X) && L.hostname !== X && (W = !0), W && !_ && (B = B || P(), R(), setTimeout(R, 500), e(l).off(I, U).on(I, U))
            };
            ...
            function P() {
                var W = e('<a class="w-webflow-badge"></a>').attr("href", "https://webflow.com?utm_campaign=brandjs"),
                    X = e("<img>").attr("src", "https://d3e54v103j8qbb.cloudfront.net/img/webflow-badge-icon-d2.89e12c322e.svg").attr("alt", "").css({
                        marginRight: "4px",
                        width: "26px"
                    }),
                    H = e("<img>").attr("src", "https://d3e54v103j8qbb.cloudfront.net/img/webflow-badge-text-d2.c82cec3b78.svg").attr("alt", "Made in Webflow");
                return W.append(X, H), W[0]
            }
            ...
            function R() {
                ...
                W.length && W.remove(), H || C.append(B)
            }
            return y
        })
    });
    var oe = lt((Re, re) => {
        ...
        Bt.define("edit", re.exports = function(e, y, l) {
            ...
            function R() {
                I = !0, window.WebflowEditor = !0, C.off(_, P), b(function(E) {
                    e.ajax({
            ...
            function W(E) {
                return function(m) {
                    ...
                    m.thirdPartyCookiesSupported = E, X($(m.scriptPath), function() {
            ...
            function b(E) {
                ...
                m.onerror = function() {
                    f(m, M), E(!1)
                }, window.addEventListener("message", M, !1), window.document.body.appendChild(m)
            }

            function f(E, m) {
                window.removeEventListener("message", m, !1), E.remove()
            }
            return T
        });
    ...
    var ae = lt((Be, se) => {
        ...
        ze.define("focus-visible", se.exports = function() {
            function e(l) {
                ...
                document.addEventListener("keydown", P, !0), document.addEventListener("mousedown", R, !0), document.addEventListener("pointerdown", R, !0), document.addEventListener("touchstart", R, !0), document.addEventListener("visibilitychange", H, !0), $(), l.addEventListener("focus", W, !0), l.addEventListener("blur", X, !0)
            }
    ...
    var he = lt((De, le) => {
        ...
        _t.define("links", le.exports = function(e, y) {
            ...
            function W() {
                C = g && _t.env("design"), R = _t.env("slug") || L.pathname || "", _t.scroll.off(H), P = [];
                for (var q = document.links, b = 0; b < q.length; ++b) X(q[b]);
        ...
        Me.define("touch", pe.exports = function(e) {
            ...
            function T(g) {
                var L = !1,
                    ...
                    B, U;
                g.addEventListener("touchstart", P, !1), g.addEventListener("touchmove", R, !1), g.addEventListener("touchend", W, !1), g.addEventListener("touchcancel", X, !1), g.addEventListener("mousedown", P, !1), g.addEventListener("mousemove", R, !1), g.addEventListener("mouseup", W, !1), g.addEventListener("mouseout", X, !1);
                ...
                function R($) {
                    if (L) {
                        ...
                        var q = $.touches,
                            ...
                            f = b - U;
                        U = b, Math.abs(f) > I && l && String(l()) === "" && (C("swipe", $, {
                ...
                function W($) {
                    if (L && (L = !1, _ && $.type === "mouseup")) {
                        $.preventDefault(), $.stopPropagation(), _ = !1;
                        return
                    }
                }
                ...
                function H() {
                    g.removeEventListener("touchstart", P, !1), g.removeEventListener("touchmove", R, !1), g.removeEventListener("touchend", W, !1), g.removeEventListener("touchcancel", X, !1), g.removeEventListener("mousedown", P, !1), g.removeEventListener("mousemove", R, !1), g.removeEventListener("mouseup", W, !1), g.removeEventListener("mouseout", X, !1), g = null
                }
                this.destroy = H
            }
